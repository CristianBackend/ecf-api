import {
  ...
  Home, Building2, Shield, Key, CreditCard, FileCheck2,
} from 'lucide-react';
...
export const ADMIN_NAV_ITEMS: NavItem[] = [
  ...
  { href: '/certification',          label: 'Certificación DGII',    icon: FileCheck2 },
  { href: '/certification-step3',    label: 'Certificación Paso 3',  icon: FileCheck2 },
  { href: '/certification-step5',    label: 'Certificación Paso 5',  icon: FileCheck2 },
