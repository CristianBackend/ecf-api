/*
  ...
  - A unique constraint covering the columns `[tenant_id,rnc]` on the table `buyers` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "buyers_tenant_id_rnc_key" ON "buyers"("tenant_id", "rnc");
